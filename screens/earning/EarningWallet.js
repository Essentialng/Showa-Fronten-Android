      ...
      >
        ...
        {/* {analytics?.monthly_history?.length > 0 && (
          <View style={styles.chartContainer}>
            ...
            <CustomChart 
              data={analytics.monthly_history.slice(0, 6).reverse()} 
              title="Last 6 Months"
            />
          </View>
        )} */}
        ...
        {/* <View style={styles.quickActionsContainer}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              ...
              <Text style={styles.quickActionSubtext}>Earn 50 coins each</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.quickActionSubtext}>View all history</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.quickActionSubtext}>Cash out</Text>
            </TouchableOpacity>
          </View>
        </View> */}
