...
useEffect(()=>{
  ...
  const markMessagesAsRead = async (chatId, chatType) => {
    ...
    setReadChats(prev => {
      ...
      saveReadChats(newSet); // Save to AsyncStorage
      return newSet;
    });
    ...
    try {
      ...
      setReadChats(prev => {
        ...
        saveReadChats(newSet); // Update AsyncStorage
        return newSet;
      });
      // Refresh chat list to restore correct unread counts
      fetchChatList();
    }
  };
      ...
      >
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerIcons}>
            ...
            {showDropdown && (
              <View style={[styles.dropdownMenu, { backgroundColor: colors.backgroundSecondary, borderColor: colors.border, color:colors.textInverse }]}>
                <Text style={[styles.dropdownItem,{fontWeight:'bold', color:colors.text}]}>Personal Account</Text>
                <Divider />
                <TouchableOpacity
                  onPress={() => {
                    setShowDropdown(false);
                ...
                >
                  <Text style={styles.dropdownItem}>Viewer</Text>
                </TouchableOpacity> */}
                {/* <TouchableOpacity
                  onPress={() => {
                    setShowDropdown(false);
                    navigation.navigate('Broadcaster', {
                      roomName: `match-${userId}`,
                ...
                >
                  <Text style={[styles.modalButtonText, { color: colors.text, marginBottom: 15, marginLeft: 5, marginTop: 10 }]}>
                    Switch Account
                  </Text>
                </TouchableOpacity>
              </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          isInitialLoading ? (
            ...
            //            <Text style={{ fontSize: 20, color: "#333", marginTop: 10 }}>
            //             Ask Showa Ai
            //         </Text>
            //         </TouchableOpacity>
...
////======================= working perfectly with dark them ===================
...
//             {showDropdown && (
//               <View style={styles.dropdownMenu}>
//                 <Text style={[styles.dropdownItem,{fontWeight:'bold'}]}>Personal Account</Text>
//                 <Divider />
//                 <TouchableOpacity
//                   onPress={() => {
//                     setShowDropdown(false);
...
//                   }}
//                 >
//                   <Text style={styles.dropdownItem}>Live-Stream-List</Text>
//                 </TouchableOpacity> */}
//                 <TouchableOpacity
//                   onPress={() => {
//                     setShowDropdown(false);
...
//                   }}
//                 >
//                   <Text style={[styles.modalButtonText, { color: '#333', marginBottom: 15, marginLeft: 5, marginTop: 10 }]}>
//                     Switch Account
//                   </Text>
//                 </TouchableOpacity>
//               </View>
...
////////////////////// WORKING WITHOUT CONTACT COUNT PER ==============================
...
//                   }}
//                 >
//                   <Text style={styles.dropdownItem}>GoLive broadcaster</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity
//                   onPress={() => {
//                     setShowDropdown(false);
...
//                     Please wait while we sync your contacts—it may take a moment.
//                   </Text>
//                 )}
//               </>
//             ) : (
...
//   const [syncComplete, setSyncComplete] = useState(false);
//   const [readChats, setReadChats] = useState(new Set());
//   const [callerInfo, setCallerInfo] = useState({ profile_picture: '', name: 'Incoming Call' });
//   const [showIncomingCallModal, setShowIncomingCallModal] = useState(false);
//   const [notificationSettings, setNotificationSettings] = useState({
//     showNotifications: true,
//     doNotDisturb: false,
...
//         setFilteredChatList(parsedChats);
//         setIsInitialLoading(false);
//       }
//     } catch (error) {
//       console.error('Error loading cached chats:', error);
...
//         extraData={chatList}
//         renderItem={({ item }) => (
//           console.log('Rendering chat itemmmmmmmmmmmmmmmm:', item),
//           <TouchableOpacity
//             onPress={() => {
//               markMessagesAsRead(item.id, item.type);
//               if (item.type === 'group') {
...
//               source={
//                 item.avatar
//                   ? { uri: item.avatar } // Remote image
//                   : item.type === 'group'
//                   ? { uri: 'https://via.placeholder.com/50/cccccc/808080?text=G' } // Placeholder for group
//                   : require('../assets/images/avatar/blank-profile-picture-973460_1280.png') // Local image
//               }
//               style={styles.avatar}
//             />
//             <View style={styles.chatContent}>
...
// import colors from '../theme/colors';
// import SwitchAccountSheet from '../components/SwitchAccountSheet';
// import VoiceCallScreen from '../components/VoiceCalls';
...
//       setSyncComplete(true);
//       setHasCompletedSync(true);
//       await AsyncStorage.setItem('hasCompletedSync', 'true'); // Store in AsyncStorage
...
//     // Launch camera after permission is granted
//     const response = await launchCamera({
//       mediaType: 'mixed', // Use 'photo' for images, 'video' for videos, or 'mixed' for both
//       quality: 0.7,
//       includeBase64: false,
//       saveToPhotos: true,
//       cameraType: 'back',
...
// //   } catch (err) {
// //     setError('Failed to load chats. Pull down to refresh.');
...
// //     formData.append('media', {
// //       uri: media.uri,
// //       type: media.type || (media.type?.includes('video') ? 'video/mp4' : 'image/jpeg'),
// //       name: media.fileName || `status_${Date.now()}.${media.type?.includes('video') ? 'mp4' : 'jpg'}`,
// //     });
...
//             <View style={styles.headerIcons}>
//              <TouchableOpacity onPress={handleCameraLaunch}>
//   <Icon name="camera-outline" size={24} color="#fff" style={{marginRight: 20}} />
// </TouchableOpacity>
//               <TouchableOpacity onPress={() => setShowDropdown(!showDropdown)}>
//                 <Icon name="ellipsis-vertical" size={22} color="#fff" />
//               </TouchableOpacity>
...
//             <Text style={styles.modalSubtitle}>Start a chat with your friends</Text>
...
//                     <View style={{flexDirection: 'row', alignItems: 'center'}}>
//                       <Text style={styles.chatName}>
//                         {item.name || (item.type === 'group' ? 'Group Chat' : 'Unnamed Chat')}
//                       </Text>
//                       {item.type === 'group' && (
//                         <>
//                           <Icon 
