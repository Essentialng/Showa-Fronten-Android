...
//   const fetchShorts = async (forceRefresh = false) => {
//     try {
//       if (!forceRefresh) {
...
//         prevShorts.map(short => 
//           short.user.id === userId 
//             ? { DollarGeneral: short, is_following: false } 
//             : short
//         )
//       );
...
//         )
//       );
//       console.error('Like Errorfff:', error.response?.data || error.message);
...
// const fetchCommentsForShort = async (shortId, page = 1, showLoading = true, isLoadMore = false) => {
//   try {
...
//     if (page === 1 && !cachedComments && showLoading) {
...
// const renderCommentItem = useCallback(({ item: cmt }) => {
...
//           <TouchableOpacity
//             onPress={() => {
//               setSelectedCommentId(cmt.id === selectedCommentId ? null : cmt.id);
//               setCommentText('');
//             }}
//             style={[
//               styles.replyBtn,
//               selectedCommentId === cmt.id && styles.replyBtnActive,
//             ]}
//           >
//             <Text style={[
//               styles.replyBtnText,
//               selectedCommentId === cmt.id && styles.replyBtnTextActive
//             ]}>
//               {selectedCommentId === cmt.id ? 'Cancel' : 'Reply'}
//             </Text>
//           </TouchableOpacity>
...
//     </TouchableOpacity>
//   );
// }, [selectedCommentId, likedComments, expandedReplies]);
...
//                 style={{borderColor:'#fff',borderWidth:1,borderRadius:5,padding:5,marginBottom:20,alignItems:'center'}}
...
//             <TouchableOpacity onPress={() => navigation.navigate('FollowedUserProfile', { userId: item.user.id })}>
...
//   onEndReached={() => {
//     if (hasMoreComments && !isCommentsLoading && !isLoadingMoreComments && selectedShort?.id) {
...
// const BOTTOM_CONTENT_HEIGHT = getBottomContentHeight(); // Define this at the top level
...
//               <TouchableOpacity 
//                 //onPress={() => navigation.navigate('FollowedUserProfile', { userId: item.user.id })}
...
//                   style={styles.shortvatar}
//                 />
//                 <Text style={styles.username}>@{item.user.name.slice(0,3)+'..'}</Text>
...
//               {activeTab === 'following' 
//                 ? "Follow some creators to see their videos!"
//                 : "Discover amazing shorts! Loading."}
//             </Text>
//           </View>
//         }
//       />
...
//   captionContainer: {
//     width: '80%',
//     marginBottom: BOTTOM_SAFE_AREA, // Add safe area padding
//   },
//   caption: {
//     color: '#fff',
//     fontSize: 14,
...
//   const renderCommentItem = useCallback(({ item: cmt }) => {
//     const commentUser = getCommentUser(cmt);
//     console.log('Renderingfff comment by user:', cmt);
...
//           {/* Bottom Content - Responsive Positioning */}
