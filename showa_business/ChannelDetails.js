...
export default function ChannelAdminScreen({ route, navigation }) {
  ...
  const pickFile = async () => {
    setModalVisible(false);
    try {
      // UPDATED: Using the new @react-native-documents/picker API
      const result = await pick({
        allowMultiSelection: false,
        presentationStyle: 'fullScreen',
        copyTo: 'cachesDirectory', // Optional: where to temporarily store the file
      });
      ...
      // UPDATED: Using isCancel from the new package
      if (!isCancel(error)) {
...
// const ChannelAdminScreen = ({ route, navigation }) => {
//   const { colors, theme, isDark } = useTheme(); // Get theme colors and state
...
//   // Create options array with theme colors
//   const options = [
//     { 
//       id: '1', 
//       icon: 'camera-alt', 
...
//   // ... (rest of your functions remain the same, just with theme updates where needed)
...
//       return (
//         <View style={styles.messageContainer}>
//           <Text style={[styles.deletedMessage, { color: colors.textSecondary }]}>This message was deleted</Text>
//         </View>
//       );
//     }
...
//         <View style={[
//           styles.messageContainer,
//           isMyMessage ? [styles.myMessage, { backgroundColor: colors.primary }] : [styles.otherMessage, { backgroundColor: colors.surface }],
//           item.is_channel_post && [styles.channelPost, { backgroundColor: colors.surface }]
//         ]}>
//           {isMyMessage && (
//             <TouchableOpacity 
//               style={styles.messageMenuButton}
...
//             {item.file && (
//               <TouchableOpacity
//                 style={[styles.fileContainer, { backgroundColor: colors.surfaceSecondary }]}
//                 onPress={() => Linking.openURL(item.file).catch(() => alert('Cannot open file'))}
//               >
//                 <View style={{ flexDirection: 'row', alignItems: 'center' }}>
...
//               <Text style={[
//                 styles.messageText, 
//                 { color: isMyMessage ? colors.textInverse : colors.text }
//               ]}>
//                 {item.content}
//               </Text>
//             )}
...
//               isMyMessage ? styles.myReactions : styles.otherReactions
//             ]}>
//               <View style={[styles.reactionsBubble, { backgroundColor: colors.surfaceSecondary }]}>
//                 {item.reactions.slice(0, 3).map((reaction, index) => (
//                   <Text key={index} style={styles.reactionEmoji}>
//                     {reaction.emoji}
//                   </Text>
...
//               <Image
//                 source={profile_image ? { uri: `${API_ROUTE_IMAGE}${profile_image}` } : FALLBACK_AVATAR}
//                 style={[styles.headerAvatar, { borderColor: 'rgba(255,255,255,0.2)' }]}
//               />
//               <View>
//                 <Text style={[styles.headerName, { color: colors.textInverse }]}>{name}</Text>
...
//             </View>
//             <TouchableOpacity onPress={openMenu} style={styles.menuButton}>
//               <Icon name="more-vert" size={24} color={colors.textInverse} />
//             </TouchableOpacity>
//           </View>
//         </LinearGradient>
...
//                   }}
//                 >
//                   <Text style={[styles.menuItemText, styles.leaveText, { color: colors.error }]}>Leave Room</Text>
//                 </TouchableOpacity>
//               </View>
//             </View>
//           </TouchableWithoutFeedback>
...
//         <Modal transparent visible={isImageLoading} onRequestClose={() => {}}>
//           <View style={[styles.loadingModalOverlay, { backgroundColor: colors.overlay }]}>
//             <View style={[styles.loadingModalContent, { backgroundColor: colors.surface }]}>
//               <ActivityIndicator size="large" color={colors.primary} />
//             </View>
//           </View>
//         </Modal>
...
//           onRequestClose={() => setFullscreenImage(null)}
//         >
//           <View style={[styles.fullscreenImageOverlay, { backgroundColor: colors.overlay }]}>
//             <TouchableWithoutFeedback onPress={() => setFullscreenImage(null)}>
//               <Image 
//                 source={{ uri: fullscreenImage }} 
//                 style={styles.fullscreenImage} 
...
//         <Modal transparent visible={imagePreviewModalVisible} onRequestClose={() => setImagePreviewModalVisible(false)}>
//           <View style={[styles.imagePreviewModalOverlay, { backgroundColor: colors.background }]}>
//             <View style={[styles.imagePreviewModalContent, { backgroundColor: colors.background }]}>
//               <View style={styles.imagePreviewHeader}>
//                 <TouchableOpacity
//                   onPress={() => {
//                     setImagePreviewModalVisible(false);
...
// export default ChannelAdminScreen;
