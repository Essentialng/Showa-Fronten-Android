...
const SuccessStoriesScreen = () => {
  ...
  const renderCategoryTag = (category) => {
    const colors = {
      'Business Growth': ['#667eea', '#4c4ba2ff'],
      'Community Impact': ['#f093fb', '#f5576c'],
      'Personal Journey': ['#4facfe', '#00f2fe'],
      'Education Innovation': ['#43e97b', '#38f9d7']
    };

    return (
      <LinearGradient
        colors={colors[category] || ['#0d64dd', '#0750b5']}
          ...
          {successStories.map((story, index) => {
            ...
            return (
              <View key={story.id} style={[
                ...
                {renderCategoryTag(story.category)}
