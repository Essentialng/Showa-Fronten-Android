...
// const sendBroadcasterLiveData = async (broadcaster) => {
//   try {
//     await fetch(`${API_ROUTE}/live-streams/`, {
//       method: "POST",
//       headers: {
...
//         profile_image: broadcaster.profileImage,
//         started_at: new Date().toISOString(),
//       }),
//     });
//     console.log("[Broadcaster] Live data sent to backendddddddddddddddd",JSON.stringify(), broadcaster);
//   } catch (err) {
            ...
            <View style={styles.streamInfo}>
              {/* <View style={styles.broadcasterInfo}>
                {broadcasterData.profileImage ? (
                  <Image
                    source={{ uri: `${API_ROUTE_IMAGE}${broadcasterData.profileImage}` }}
